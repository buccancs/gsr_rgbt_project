...
5. Visualizes and repo_forensic results
...
def visualize_results(plot_history=True, plot_predictions=True, model_comparison=True):
    ...
    Args:
        ...
        model_comparison (bool): Whether to generate model comparison repo_forensic
...
def main():
    ...
    for model_type in models_to_train:
        ...
        logging.info(
            f"  Training: {'Success' if pipeline_steps['model_training'].get(model_type, False) else 'Failed'}")
