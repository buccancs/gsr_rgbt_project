...
def plot_training_history(history_file, output_path=None):
    """
...
def plot_predictions_vs_ground_truth(predictions_file, output_path=None):
    """
...
def generate_model_comparison_report(results_file, output_path=None):
    """
...
def main():
    ...
    if args.plot_history or args.all:
        ...
        for history_file in history_files:
            if plot_training_history(history_file):
    ...
    if args.plot_predictions or args.all:
        ...
        for prediction_file in prediction_files:
            if plot_predictions_vs_ground_truth(prediction_file):
    ...
    if args.model_comparison or args.all:
        ...
        for results_file in results_files:
            if generate_model_comparison_report(results_file):
                processed_items["comparison_reports"] += 1
    
    # Save model milestone
    if args.save_milestone or args.all:
        model_type = args.save_milestone if args.save_milestone else "lstm"
