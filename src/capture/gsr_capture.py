...
class GsrCaptureThread(QThread):
    """
    A dedicated QThread to handle GSR data acquisition.
    ...
    def __init__(
        ...
        self.setObjectName("GSRCaptureThread")

    def run(self):
        """
        The main execution method of the thread.
        Initiates either the simulation or the real hardware capture loop.
        """
        logging.info("GSR capture thread started.")
        ...
        logging.info("GSR capture thread has finished.")
        self.finished.emit()
    ...
    def stop(self):
        ...
        """
        logging.info("Stopping GSR capture thread.")
        self.is_running = False
