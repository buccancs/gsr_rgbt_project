# src/tests/unit/gui/test_main_window.py
...
class TestMainWindow(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch('src.gui.main_window.RealTimeVisualizer')
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.window.windowTitle(), "GSR-RGBT Analysis")
    ...
    @patch('src.gui.main_window.QImage')
    @patch('src.gui.main_window.QPixmap')
    ...
    def test_connect_gsr_signal(self):
        ...
        mock_gsr_thread.gsr_data_point.connect.assert_called_with(
            self.mock_visualizer.update_gsr_data
        )
