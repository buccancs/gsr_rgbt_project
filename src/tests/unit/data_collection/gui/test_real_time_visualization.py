# src/tests/unit/data_collection/gui/test_real_time_visualization.py
...
from src.data_collection.gui.real_time_visualization import RealTimeVisualizer, GSRPlotCanvas
...
class TestGSRPlotCanvas(unittest.TestCase):
    ...
    @patch('src.data_collection.gui.real_time_visualization.time.time')
...
class TestRealTimeVisualizer(unittest.TestCase):
    ...
    def test_reset(self):
        ...
        # Call reset
        with patch('src.data_collection.gui.real_time_visualization.time.time') as mock_time:
            mock_time.return_value = 100.0
