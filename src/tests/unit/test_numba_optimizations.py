# src/tests/unit/test_numba_optimizations.py
...
try:
    from src.processing.numba_optimizations import nb_align_signals, nb_create_feature_windows
...
class TestNumbaOptimizations(unittest.TestCase):
    ...
    def test_nb_align_signals(self):
        ...
        nb_aligned_df = nb_aligned_df[py_columns]
    ...
    def test_nb_align_signals_edge_cases(self):
        ...
        # Note: The Numba implementation should handle this case correctly
    ...
    def test_nb_create_feature_windows_edge_cases(self):
        ...
        self.assertEqual(nb_y.shape[0], 0)
